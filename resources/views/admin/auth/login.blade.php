...
@section('title', 'Admin Login - Otika')
      ...
      <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
              ...
              <div class="form-group">
                <div class="d-block">
                  ...
                  <div class="float-right">
                    {{-- Hook up later if you want admin password reset --}}
            ...
            {{-- Kept for appearance; not wired up --}}
        ...
        {{-- Admins should be created by seed/admin action; keep this hidden later --}}
