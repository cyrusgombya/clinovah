<nav class="navbar navbar-expand-lg main-navbar sticky">
  ...
  <ul class="navbar-nav navbar-right">
    <!-- Messages dropdown (kept as-is for now) -->
    <li class="dropdown dropdown-list-toggle">
      ...
      <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
        ...
        <div class="dropdown-list-content dropdown-list-message">
          ...
          <a href="#" class="dropdown-item">
            <span class="dropdown-item-avatar text-white">
              <img alt="image" src="{{ asset('assets/admin/img/users/user-5.png') }}" class="rounded-circle">
            </span>
            <span class="dropdown-item-desc">
          ...
          <a href="#" class="dropdown-item">
            <span class="dropdown-item-avatar text-white">
              <img alt="image" src="{{ asset('assets/admin/img/users/user-4.png') }}" class="rounded-circle">
            </span>
            <span class="dropdown-item-desc">
          ...
          <a href="#" class="dropdown-item">
            <span class="dropdown-item-avatar text-white">
              <img alt="image" src="{{ asset('assets/admin/img/users/user-3.png') }}" class="rounded-circle">
            </span>
            <span class="dropdown-item-desc">
    ...
    <!-- Notifications dropdown (kept as-is for now) -->
    <li class="dropdown dropdown-list-toggle">
