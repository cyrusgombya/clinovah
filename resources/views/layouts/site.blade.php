...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .cv-logo-text span { color: var(--cv-orange); }
    ...
    .cv-footer a:hover { color: var(--cv-orange); }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
      <div class="container">
        <a class="navbar-brand cv-logo d-flex align-items-center gap-2" href="{{ route('site.home') }}">
          <img src="{{ asset('assets/clin/images/logo/clinovah.png') }}" alt="Clinovah Logo" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline-block';">
          <span class="cv-logo-text" style="display:none;">Clin<span>o</span>vah</span>
        </a>

        <button class="navbar-toggler border-0 shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#cvMainNav">
        ...
        <div class="collapse navbar-collapse" id="cvMainNav">
          <ul class="navbar-nav mx-auto gap-lg-2 mt-3 mt-lg-0">
            <li class="nav-item">
              <a class="cv-nav-link {{ request()->routeIs('site.home') ? 'active' : '' }}" href="{{ route('site.home') }}">Home</a>
            </li>
            <li class="nav-item">
              <a class="cv-nav-link" href="{{ route('site.home') }}#how-it-works">How it works</a>
            </li>
            <li class="nav-item">
              <a class="cv-nav-link" href="{{ route('site.home') }}#services">Services</a>
            </li>
            <li class="nav-item">
              <a class="cv-nav-link {{ request()->routeIs('clinics.*') ? 'active' : '' }}" href="{{ route('clinics.index') }}">Clinics</a>
            </li>
            <li class="nav-item">
              <a class="cv-nav-link {{ request()->routeIs('site.contact') ? 'active' : '' }}" href="{{ route('site.contact') }}">Contact</a>
            </li>
          </ul>
  ...
  @auth
    ...
    <div class="dropdown">
      <button class="cv-user-pill dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
      ...
      <ul class="dropdown-menu dropdown-menu-end border-0 shadow rounded-4 p-2">
        <li>
          <a class="dropdown-item rounded-3 fw-bold" href="{{ route('dashboard.appointments') }}">
            My Bookings
          </a>
        </li>

        <li>
          <a class="dropdown-item rounded-3 fw-bold" href="{{ route('profile.edit') }}">
            Profile
          </a>
        </li>
        ...
        <li>
          <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="dropdown-item rounded-3 fw-bold text-danger">
              Logout
            </button>
          </form>
        </li>
  ...
  <footer class="cv-footer">
    <div class="container">
      <div class="row g-4">
        <div class="col-lg-4">
          <a class="cv-logo d-inline-flex align-items-center gap-2 mb-3" href="{{ route('site.home') }}">
            <img src="{{ asset('assets/clin/images/logo/clinovah.png') }}" alt="Clinovah Logo" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline-block';">
            <span class="cv-logo-text" style="display:none;">Clin<span>o</span>vah</span>
          </a>
          <p>Clinovah helps patients find verified clinics, book appointments, and manage visits with less friction.</p>
        </div>
        ...
        <div class="col-lg-4">
          <h6>Contact</h6>
          <p class="mb-1">Galuleeba Commercial Plaza, Wakiso Town, S26 Uganda</p>
          <p class="mb-1"><a href="tel:+256200948068">+256 200 948068</a></p>
          <p class="mb-0"><a href="mailto:Contact@clinovah.com">Contact@clinovah.com</a></p>
        </div>
      </div>
  ...
  <div class="cv-mobile-bottom-nav d-lg-none">
    <div class="d-flex justify-content-around align-items-end">
      <a href="{{ route('site.home') }}" class="{{ request()->routeIs('site.home') ? 'active' : '' }}">
        <i class="ri-home-5-line d-block fs-5"></i>Home
      </a>

      @auth
        <a href="{{ route('dashboard.appointments') }}" class="{{ request()->routeIs('dashboard.appointments') ? 'active' : '' }}">
          <i class="ri-calendar-check-line d-block fs-5"></i>Bookings
        </a>
      @else
        <a href="{{ route('login') }}">
          <i class="ri-calendar-check-line d-block fs-5"></i>Bookings
      ...
      <a href="{{ route('clinics.index') }}" class="{{ request()->routeIs('clinics.*') ? 'active' : '' }}">
        <i class="ri-search-line d-block fs-5"></i>Search
      </a>
      

      @auth
        <a href="{{ route('dashboard') }}" class="{{ request()->routeIs('dashboard') ? 'active' : '' }}">
          <i class="ri-user-3-line d-block fs-5"></i>Dashboard
        </a>
      @else
        <a href="{{ route('login') }}">
          <i class="ri-user-3-line d-block fs-5"></i>Login
        </a>
      @endauth
    </div>
  </div>
