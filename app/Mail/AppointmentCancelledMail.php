    ...
    protected function renderHtml(): string
    {
        ...
        <div style='font-family:Arial,sans-serif;background:#fff7ed;padding:32px;'>
            <div style='max-width:620px;margin:auto;background:#ffffff;border-radius:24px;padding:34px;box-shadow:0 20px 60px rgba(14,82,63,0.08);'>
                ...
                <h2 style='color:#b91c1c;margin-bottom:12px;'>Appointment Cancelled</h2>

                <p style='color:#40574f;line-height:1.7;'>
                    Your appointment at <strong>" . ($a->clinic?->name ?? 'Clinic') . "</strong> has been cancelled.
                </p>

                <div style='background:#fff7ed;padding:18px;border-radius:14px;margin:20px 0;color:#12332a;'>
                    ...
                    <p><strong>Reason:</strong> " . ($a->cancellation_reason ?: 'Not specified') . "</p>
                    <p><strong>Note:</strong> " . ($a->cancellation_note ?: 'No extra note provided.') . "</p>
                </div>

                <p style='color:#40574f;line-height:1.7;'>
                    You can book another appointment through Clinovah.
                </p>
